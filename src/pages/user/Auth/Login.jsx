...
export default function Login() {
  ...
  const loginForm = useFormik({
    ...
    validationSchema: yup.object({
      ...
      cyberSoftToken: yup.string().required("CyberSoft Token is required"),
    }),
    ...
    <div className="bg-white p-10 w-[400px]  rounded-xl">
      ...
      >
        ...
        <TextField
          className="w-full"
          id="cyberSoftToken"
          label="CyberSoft Token"
          variant="standard"
          value={loginForm.values.cyberSoftToken}
          onChange={loginForm.handleChange}
          onBlur={loginForm.handleBlur}
          error={
            loginForm.touched.cyberSoftToken && loginForm.errors.cyberSoftToken
          }
          helperText={
            loginForm.touched.cyberSoftToken && loginForm.errors.cyberSoftToken
          }
      ...
      <div className="flex justify-center items-center gap-2">
        ...
        <Link className="text-blue-500" to="/account/register">
          Register Account
        </Link>
      </div>
    </div>
